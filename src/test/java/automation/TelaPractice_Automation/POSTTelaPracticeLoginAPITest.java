...
public class POSTTelaPracticeLoginAPITest {

	TestBase testBase;

	@DataProvider(name = "signIn")
	public String[][] getData() throws BiffException, IOException {
		String filePath = "res" + File.separator + "TP_createProviderGroup.xls";
		String[][] userData = testBase.getData(filePath, 0);
	...
	public void telaPractiseLoginTest(String method, String url,Map<String, String> headers, String body, String ScenarioName,
