...
public class PUTUpdatePatientAPITest {
...
TestBase testBase;
	...
	@Test(priority=1)
	public void updatePatientWithValidDeatils() throws SecurityException, Exception
	{
		...
		testdata.put("patientUUID", response.getBody().jsonPath().getString("data.content[0].uuid"));
		
		PUTUpdatePatientAPI updatePatient = new PUTUpdatePatientAPI(testBase);
		response = updatePatient.sendUpdatePatientRequest(testdata);
